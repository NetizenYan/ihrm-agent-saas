    ...
    <div class="cont-top-box">
      <div class="top-lable">
        ...
        <div class="lable-tit">
          ...
          <router-link :to="{'path':'/salarys/monthStatement',query:{'yearMonth':yearMonth}}">{{yearMonth}}月报表</router-link>
        </div>
      </div>
    </div>
    <div class="approvalsContent">
      ...
      <div class="content">
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="formOfEmployment" :formatter="forEmployment" width="100" label="聘用形式"></el-table-column>
          <el-table-column prop="departmentName" label="部门" width="100"></el-table-column>
          <el-table-column prop="timeOfEntry" :formatter="transformDateFormat" width="130" label="入职时间"></el-table-column>
