    ...
    <div class="monthStatementTable">
      <div class="itemDropDown">
        ...
        <el-table :data="contentData" border style="width: 100%;text-align: center" id="item">
          ...
          <el-table-column prop="inServiceStatus" :formatter="inService" label="在职状态" width="150px"></el-table-column>
          ...
          <el-table-column prop="currentBaseSalary" label="岗位工资" width="150px"></el-table-column>
          <el-table-column prop="salaryChangeAmount" label="福利津贴" width="150px"></el-table-column>
