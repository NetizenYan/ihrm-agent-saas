...
export const getArchivingCont = data => createAPI(`/attendances/reports/${data.atteArchiveMonthlyId}`, 'get')
...
export const atteArchiveDetail = data => createAPI(`/attendances/archive/${data.userId}/${data.yearMonth}`, 'get')
