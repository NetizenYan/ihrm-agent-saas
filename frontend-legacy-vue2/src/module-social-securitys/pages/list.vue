    ...
    <div class="app-container">
      ...
      <div class="cont-bod-box">
        <el-table @row-click="goDetail" :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="timeOfEntry" :formatter="transformDateFormat" label="入职时间" width="120" sortable></el-table-column>
          <el-table-column prop="leaveTime" :formatter="transformDateFormat" label="离职时间"  width="120"  sortable></el-table-column>
